...
insert into Cliente (id, contato, cpf, email, nome) values (1, '21956679098', '38466546464', 'esimonot0@apple.com', 'Elnore Simonot');
insert into Cliente (id, contato, cpf, email, nome) values (2, '21998299755', '09987674056', 'jann1@amazon.de', 'Jo ann Arger');
